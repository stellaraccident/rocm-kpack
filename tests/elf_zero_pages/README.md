...
2. **Split PT_LOAD segment** into up to 5 pieces:
...
2. ✅ **Partial pages must be preserved** (conservative approach works)
3. ✅ **File size reduction**: 15-27% for test cases, ~63% for typical HIP binaries
4. ✅ **Runtime behavior**: Zero-paged regions appear as zeros in memory
5. ⚠️ **Section alignment**: Linker automatically aligns sections to page boundaries
